    ...
    return (
        <div className="work">
            <div className="top">
                ...
                <div className="title">
                    <div className="val">
                        <span className="bigtit">Fasi di realizzazione del progetto</span>
                    </div>
                    <div className=""></div>
                </div>
            </div>
		...
		c0-22.888-18.576-41.448-41.464-41.448C233.095,214.544,214.536,233.104,214.536,255.992z"/>
            ...
            <div className="top more">
                ...
                <div className="text">
                    <div className="val">
                        <span className='tit'>
                            Le tecnologie che andiamo ad utilizzare variano naturalmente da progetto a progetto in base alle specifiche richieste.
                            Utilizziamo software specifici per la collaborazione con il cliente, cosi da mantenere il più possibile frequenti i feedback di quest'ultimo
                        </span>
                    </div>
                </div>
                <div className="title">
                    <div className="val">
                        <span className="bigtit">Le tecnologie che utilizziamo</span>
                    </div>
                    <div className=""></div>
                </div>
            </div>
